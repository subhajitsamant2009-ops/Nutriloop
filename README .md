...
| Page | What it does |
|---|---|
| 🥗 **Nutrition** | Search 20+ foods, adjust serving size, view macros + 7 micronutrient bars |
| 📋 **Meal Log** | Log foods from the nutrition page or add custom entries; daily calorie/protein/carb totals |
| 💧 **Water** | 8-glass hydration tracker with visual cups and motivational messages |
| ⚖️ **BMI** | Weight + height + age + gender → BMI score, category, colour-coded scale, and advice |
| 🏃 **Exercise** | 6 profiles (Beginner, Intermediate, Advanced, Senior 60+, Kids 6–14, Prenatal) each with 7 exercises + a 7-day weekly plan |
...
> **Tip:** For the best development experience, use the [Live Server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer) VS Code extension so the browser auto-reloads on save.
...
4. Click **Save**.
5. Your app is live at `https://YOUR_USERNAME.github.io/nutrifit/` in ~1 minute.
